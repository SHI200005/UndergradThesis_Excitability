...
[t_1,S_1,y_1]=time(eta_s,eta_c-eta_s,60,20,34.1,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_2,S_2,y_2]=time(eta_s,eta_c-eta_s,60,20,35.2,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_3,S_3,y_3]=time(eta_s,eta_c-eta_s,250,30,215,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_4,S_4,y_4]=time(eta_s,eta_f-eta_s,60,20,27.5,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_5,S_5,y_5]=time(eta_s,eta_f-eta_s,60,20,28.3,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
