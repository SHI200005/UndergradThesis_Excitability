...
[t_1,S_1,y_1]=time(eta_s,eta_c-eta_s,160,30,65.5,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
% [t_2,S_2,y_2]=time(eta_s,eta_c-eta_s,160,30,67,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_3,S_3,y_3]=time(eta_s,eta_c-eta_s,250,50,150,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_4,S_4,y_4]=time(eta_s,eta_f-eta_s,120,30,43,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
% [t_5,S_5,y_5]=time(eta_s,eta_f-eta_s,120,30,45,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
[t_6,S_6,y_6]=time(eta_s_2,eta_f-eta_s_2,250,50,150,n,theta_y,theta_z,K,kappa,alpha,beta_x,beta_y,beta_z);
